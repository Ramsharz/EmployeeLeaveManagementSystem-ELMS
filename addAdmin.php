	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<a href="admin.php">Admin /</a> <li class="active">Add Admin</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					<form role="form" name="loginForm"  method = "post" action="<?=create_admin()?>">
						<fieldset>
                        <div class="form-group">
								<input class="form-control" placeholder="First Name" name="uname" type="text" autofocus="" >
							</div>
                            <div class="form-group">
                      ...
                      required>
							...
							<div class="form-group">
								<input class="form-control" placeholder="Password" name="pwd" type="password" value=""  pattern=".{6,}" title="Six or more characters" required >
							</div>
