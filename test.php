...
<a id= "navbtn" style = "float: right"><span class="fa fa-home"></span></a>
<?php include("nav-bar2.php");?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		?>
		<div class="panel panel-container"  style = "display: <?=$display?>">
			<div class="row" >
		...
		<div class="panel panel-container"  style = "display: <?=$display2?>">
		<div class = "row" >
