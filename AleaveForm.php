				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-8 col-lg-offset-2">
							<form role="form" method = "post" action = "applyleave.php">
...
<input class="form-control" placeholder="From" name="uname" type="text" autofocus="" value = "<?=$_SESSION["name"]?>" readonly="readonly"  >   
    </div>
	
    <div class="form-group">
    <label > Employee Id: </label>
        
		<input class="form-control" placeholder="From" name="emp" type="text" autofocus="" value = "<?=$_SESSION["user_id"]?>" readonly="readonly" >  
	</div>
    <div class="form-group">
        <label > From: </label>
